...
MESSAGES: list[str] = ['Woof woof! 🐶', 'Play fetch with me! 🎾', 'Wag wag wag! 🐾', '*sniffs your shoes*', 'Did someone say TREATS?! 🦴', 'Good dog status: 100%', '*pant pant pant*', 'I brought you a stick! 🪵', 'AWOOOO! 🐺']
