...
PETS = {
    "dog": {
        ...
        "name": "Dog",
        "emoji": "🐶",
        "config_file": ".desktop_dog_config.json",
        "tray_name": "desktop_dog",
        "themes": {
            "shiba":     "🐕  Shiba Inu",
        ...
        "fills": {
            "shiba":     ("#d9822b", "#804000", "#e6953b"),
            "golden":    ("#f5b041", "#935116", "#f9e79f"),
            "black_lab": ("#2c3e50", "#1a252f", "#566573"),
            "dalmatian": ("#ecf0f1", "#7f8c8d", "#ffffff"),
            "husky":     ("#85929e", "#2c3e50", "#d6dbdf"),
        }
    },
    "fox": {
        "title": "Desktop Fox 🦊",
        "name": "Fox",
        "emoji": "🦊",
        "config_file": ".desktop_fox_config.json",
        "tray_name": "desktop_fox",
        "themes": {
            "red_fox":   "🦊  Red Fox",
            "arctic":    "❄️  Arctic White Fox",
            "fennec":    "🌾  Fennec Fox",
            "silver":    "🩶  Silver Fox",
        },
        "messages": [
            ...
            "*curls up into a fluffy ball*",
            "Chasing butterflies~ 🦋",
            "Mysterious woods calling...",
            "Sneak sneak sneak... 🐾",
            "Curious eyes watching you! 👀",
            "*pounces on leaves*",
        ],
        "fills": {
            "red_fox":   ("#e65100", "#bf360c", "#ff9800"),
            "arctic":    ("#eceff1", "#90a4ae", "#ffffff"),
            "fennec":    ("#f0a85d", "#a05a1c", "#fcd9b1"),
            "silver":    ("#37474f", "#212121", "#78909c"),
        }
    },
    "bunny": {
        "title": "Desktop Bunny 🐰",
        "name": "Bunny",
        "emoji": "🐰",
        "config_file": ".desktop_bunny_config.json",
        "tray_name": "desktop_bunny",
        "themes": {
            "white":     "🐰  White Bunny",
            "brown_lop": "🤎  Brown Lop-Eared",
            "dutch":     "🖤  Dutch Black & White",
            "sakura":    "🌸  Sakura Pink Bunny",
        },
        "messages": [
            "Hop hop hop! 🐰",
            "Munching carrots~ 🥕",
            "*wiggles nose rhythmically*",
            "Binky time! 🎉",
            "Soft & fluffy fluffball~",
            "*flops down for a nap*",
            "Ears twitching! 👂",
        ],
        "fills": {
            "white":     ("#f5f5f5", "#e0e0e0", "#ff80ab"),
            "brown_lop": ("#8d6e63", "#4e342e", "#bcaaa4"),
            "dutch":     ("#424242", "#212121", "#ffffff"),
            "sakura":    ("#ff80ab", "#c2185b", "#ffffff"),
        }
    },
    "panda": {
        "title": "Desktop Panda 🐼",
        "name": "Panda",
        "emoji": "🐼",
        "config_file": ".desktop_panda_config.json",
        "tray_name": "desktop_panda",
        "themes": {
            "classic":   "🐼  Classic Panda",
            "red_panda": "🦊  Red Panda",
            "golden":    "🍯  Golden Panda",
            "cyber":     "⚡  Cyberpunk Panda",
        },
        "messages": [
            "Nom nom bamboo! 🎋",
            "Chubby & proud 🐼",
        ...
        "fills": {
            "classic":   ("#ffffff", "#212121", "#ffffff"),
            "red_panda": ("#d84315", "#4e342e", "#ff8f00"),
            "golden":    ("#ffb300", "#ff6f00", "#ffe082"),
            "cyber":     ("#00e5ff", "#d500f9", "#00e5ff"),
        }
    },
    "penguin": {
        "title": "Desktop Penguin 🐧",
        "name": "Penguin",
        "emoji": "🐧",
        "config_file": ".desktop_penguin_config.json",
        "tray_name": "desktop_penguin",
        "themes": {
            "emperor":   "🐧  Emperor Penguin",
            "gentoo":    "🪨  Gentoo Penguin",
            "fairy_blue":"💙  Fairy Blue Penguin",
            "cyber":     "⚡  Cyberpunk Penguin",
        },
        "messages": [
            "Waddle waddle! 🐧",
            "Fish for dinner? 🐟",
            "*slides on belly across screen*",
            "Brrr, chilly & cool! ❄️",
            "Flipper flap dance! 💃",
            "Keep paddling! 🌊",
            "Formal tuxedo every day ✨",
        ],
        "fills": {
            "emperor":   ("#263238", "#ff9800", "#ffffff"),
            "gentoo":    ("#37474f", "#ff5722", "#ffffff"),
            "fairy_blue":("#0277bd", "#00acc1", "#e0f7fa"),
            "cyber":     ("#7c4dff", "#00e676", "#69f0ae"),
        }
    },
    "cow": {
        "title": "Desktop Cow 🐮",
        "name": "Cow",
        "emoji": "🐮",
        "config_file": ".desktop_cow_config.json",
        "tray_name": "desktop_cow",
        "themes": {
            "holstein":  "🐮  Holstein (B&W)",
            "jersey":    "🤎  Jersey Brown Cow",
            "swiss":     "🤍  Swiss White Cow",
            "cyber":     "⚡  Cyberpunk Cow",
        },
        "messages": [
            "Moooooo! 🐮",
            "Chewing the cud~ 🌾",
            "Fresh milk time! 🥛",
            "*tail swishes lazy flies*",
            "Green pastures forever! 🌿",
            "Moo-velous day! ✨",
            "Grazing peacefully 🐄",
        ],
        "fills": {
            "holstein":  ("#ffffff", "#212121", "#ffb7b2"),
            "jersey":    ("#a1887f", "#4e342e", "#d7ccc8"),
            "swiss":     ("#f5f5f5", "#b0bec5", "#ffcdd2"),
            "cyber":     ("#00e5ff", "#d500f9", "#00e5ff"),
        }
    },
    "buffalo": {
        "title": "Desktop Buffalo 🦬",
        "name": "Buffalo",
        "emoji": "🦬",
        "config_file": ".desktop_buffalo_config.json",
        "tray_name": "desktop_buffalo",
        "themes": {
            "bison":     "🦬  American Bison",
            "water":     "🌊  Water Buffalo",
            "cape":      "🌾  Cape Buffalo",
            "golden":    "🍯  Golden Buffalo",
        },
        "messages": [
            "Low deep grunt... 🦬",
            "Roaming the open plains! 🌾",
            "Mighty & majestic! ✨",
            "*stamps hoof powerfully*",
            "Shaggy fur & strong horns! 💪",
            "Thunderous spirit ⚡",
            "Peaceful giant 🦬",
        ],
        "fills": {
            "bison":     ("#3e2723", "#1b0000", "#8d6e63"),
            "water":     ("#37474f", "#212121", "#78909c"),
            "cape":      ("#263238", "#000000", "#546e7a"),
            "golden":    ("#ffb300", "#ff6f00", "#ffe082"),
        }
    }
}
...
_CONFIG_PATH = Path.home() / "{config_file}"
...
THEMES: dict[str, str] = {themes_dict}
MESSAGES: list[str] = {messages_list}
...
class Sprites:
    ...
    def __init__(self, scale: int, theme: str = "{default_theme}"):
...
class SettingsWin:
    ...
    def __init__(self, parent: tk.Tk, cfg: dict, on_apply):
        ...
        hdr = tk.Frame(self.top, bg=self.HEADER, pady=12, padx=16)
        hdr.pack(fill="x")
        tk.Label(hdr, text="{emoji}  {title}", font=("Segoe UI", 14, "bold"), bg=self.HEADER, fg=self.ACCENT).pack()
        ...
        tk.Label(t_row, text="{name} Version", font=("Segoe UI", 9), bg=self.BG, fg=self.TEXT, width=18, anchor="w").pack(side="left")
        curr_t = self._cfg.get("theme", "{default_theme}")
...
class DesktopPet:
    ...
    def _launch_tray(self):
        try:
            ...
            self._tray_icon = pystray.Icon("{tray_name}", img, "{title}", menu)
    ...
    def _on_right_click(self, event):
        ...
        menu.add_command(label="{emoji}  Pet Me!", command=self._pet)
        menu.add_command(label="😾  Poke (Angry!)", command=self._anger)
        menu.add_command(label="💬  Say Something", command=self._show_bubble)
        menu.add_separator()
        menu.add_command(label="🎨  {name} Version Selector...", command=self._open_version_selector)
        menu.add_separator()
    ...
    def _open_version_selector(self):
        curr = self.cfg.get("theme", "{default_theme}")
...
- 🎯 **Mouse Chasing** — Pet actively walks and turns towards your cursor when moved!
- 🎨 **Multiple Versions / Skins** — Switch between {themes_count} unique versions via Version Selector or Settings.
- 🔊 **Audio Effects** — Synthesised sound effects (barks, chirps, squeaks, moos).
...
TEMPLATE_REQ = '''Pillow>=9.0.0
pystray>=0.19.0
pywin32>=300; platform_system=="Windows"
'''

print("Building all pet projects...")

for key, data in PETS.items():
    default_theme = list(data["themes"].keys())[0]
    main_code = TEMPLATE_MAIN.format(
        config_file=data["config_file"],
        default_theme=default_theme,
        themes_dict=repr(data["themes"]),
        messages_list=repr(data["messages"]),
        title=data["title"],
        name=data["name"],
        emoji=data["emoji"],
        tray_name=data["tray_name"],
        fills_dict=repr(data["fills"]),
    )

    os.makedirs(key, exist_ok=True)
    with open(f"{key}/main.py", "w", encoding="utf-8") as f:
        f.write(main_code)
    ...
    with open(f"{key}/README.md", "w", encoding="utf-8") as f:
        f.write(readme)

    with open(f"{key}/requirements.txt", "w", encoding="utf-8") as f:
        f.write(TEMPLATE_REQ)

    print(f"  [OK] Built {key}/ (main.py, README.md, requirements.txt)")

print("All pet projects updated successfully!")
